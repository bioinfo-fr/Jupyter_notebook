...
Ce repository est desiné au 
 * paratage des connaissances
 * permettre à la communauté francophone d'avoir un repo de bioinfo (ceci n'exclus pas l'anglais dans les commentaire)
 * review par d'autre pour optimiser le code proposé (les benchmarks sont encouragé) 
